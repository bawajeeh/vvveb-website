...
DROP SEQUENCE IF EXISTS post_content_meta_seq;
CREATE SEQUENCE post_content_meta_seq;
-- SELECT setval('post_content_meta_seq', 0, true); -- last inserted id by sample data
