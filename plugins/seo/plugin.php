...
Description: Add SEO capabilities like meta for content and schema markup.
Author: givanz
Version: 0.1
Thumb: seo.svg
...
use Vvveb\Plugins\Seo\Graphql;
use Vvveb\Plugins\Seo\Rest;
...
class SeoPlugin {
	...
	function graphql() {
		//$schema = new \Vvveb\Plugins\Seo\GraphQLSchema();
		$graphql = new Graphql();
	}
