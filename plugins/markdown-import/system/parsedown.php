...
namespace Vvveb\Plugins\MarkdownImport\System;
...
class Parsedown {
	...
	protected function linesElements(array $lines) {
		...
		foreach ($lines as $line) {
			...
			if ($CurrentBlock and $CurrentBlock['type'] === 'Paragraph') {
	...
	protected function blockCode($Line, $Block = null) {
		if ($Block and $Block['type'] === 'Paragraph' and ! isset($Block['interrupted'])) {
			return;
		}
	...
	protected function blockList($Line, array $CurrentBlock = []) {
	...
	protected function blockSetextHeader($Line, array $Block = []) {
		if (! $Block or $Block['type'] !== 'Paragraph' or isset($Block['interrupted'])) {
			return;
		}
