...
class View {
	...
	function __construct($app = null) {
		...
		$this->app    = $app ?? APP;
		$relativePath = PUBLIC_PATH . 'themes' . DS;
		...
		if ($this->app == 'app') {
			...
			$relativePath = PUBLIC_PATH . $this->app . DS;
		...
		if ($this->isEditor) {
			...
			$template->setRelativePath($relativePath . $this->theme . DS);
		}
	...
	function setTheme($theme = false) {
		...
		if (! $this->isEditor) {
			$this->templateEngine->setRelativePath($relativePath . $this->theme . DS);
		}
	}
