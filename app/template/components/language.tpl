...
$language['language'] = empty($language['language']) ? $_default : $language['language'];
	...
	if (is_array($language['language'])) {
		...
		[data-v-component-language] option[data-v-language]|value = $lang['code']
		[data-v-component-language] option[data-v-language]|addNewAttribute = <?php if ($lang['code'] == $language['active']['code']) echo 'selected';?>
