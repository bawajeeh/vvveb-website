Vvveb.Sections.add("hero/hero-1", {
  ...
  <div class="container">
    ...
    <div class="frame mx-auto">
      ...
      <img src="https://www.vvveb.com/img/dark-theme.webp">
    </div>
  </div>
        ...
        <div class="row g-3 g-md-4">
            ...
            <div class="accordion faq accordion-flush" id="faq1-accordion accordion-flush">
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq1-headingOne">
                  <button aria-controls="faq1-collapseOne" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq1-collapseOne" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq1-headingTwo">
                  <button aria-controls="faq1-collapseTwo" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq1-collapseTwo" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq1-headingThree">
                  <button aria-controls="faq1-collapseThree" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq1-collapseThree" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq1-headingFour">
                  <button aria-controls="faq1-collapseFour" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq1-collapseFour" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
          ...
          <div class="col-lg-6">
            ...
            <div class="accordion faq accordion-flush" id="faq2-accordion accordion-flush">
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq1-headingOne">
                  <button aria-controls="faq2-collapseOne" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq2-collapseOne" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq2-headingTwo">
                  <button aria-controls="faq2-collapseTwo" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq2-collapseTwo" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq2-headingThree">
                  <button aria-controls="faq2-collapseThree" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq2-collapseThree" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq2-headingFour">
                  <button aria-controls="faq2-collapseFour" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq2-collapseFour" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
            ...
            <div class="accordion faq accordion-flush" id="faq3-accordion accordion-flush">
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq3-headingOne">
                  <button aria-controls="faq3-collapseOne" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq3-collapseOne" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq3-headingTwo">
                  <button aria-controls="faq3-collapseTwo" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq3-collapseTwo" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq3-headingThree">
                  <button aria-controls="faq3-collapseThree" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq3-collapseThree" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq3-headingFour">
                  <button aria-controls="faq3-collapseFour" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq3-collapseFour" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
            ...
            <div class="accordion faq accordion-flush" id="faq4-accordion accordion-flush">
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq4-headingOne">
                  <button aria-controls="faq4-collapseOne" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq4-collapseOne" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq4-headingTwo">
                  <button aria-controls="faq4-collapseTwo" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq4-collapseTwo" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq4-headingThree">
                  <button aria-controls="faq4-collapseThree" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq4-collapseThree" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
              ...
              <div class="accordion faq accordion-item">
                <h2 class="accordion faq accordion-header" id="faq4-headingFour">
                  <button aria-controls="faq4-collapseFour" aria-expanded="false" class="accordion faq accordion-button collapsed bg-light" data-bs-target="#faq4-collapseFour" data-bs-toggle="collapse" type="button">
                    <div class="text-muted me-3">
                    </div>Lorem ipsum dolor sit amet adipisicing ?
                  </button>
                </h2>
...
Vvveb.Sections.add("subscribe/subscribe-1", {
  ...
  <div class="container">
    ...
    <div class="row h-100 d-flex justify-content-center align-items-center" data-v-component-plugin-newsletter-form data-v-storage="database" data-v-name="contact-us-home">
  ...
  <div class="container">
    ...
    <div class="row h-100 d-flex justify-content-center align-items-center" data-v-component-plugin-newsletter-form data-v-storage="database" data-v-name="subscribe-footer" data-v-list="footer">
