...
Vvveb.Components.add("elements/gallery", {
    ...
    html: `
			<div class="gallery masonry has-shadow" data-component-gallery  id="gallery-RANDOM_ID">
				<div class="item">
					<a href="#">
		...
		properties: [{
			...
			onChange: function(node) {
				 node.append(generateElements('<div class="item"><img src="../../media/posts/1.jpg"></div>')[0]);
